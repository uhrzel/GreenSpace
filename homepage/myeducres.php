        ...
        <div class="slider-area2">
            <div class="slider-height2 d-flex align-items-center">
                <div class="container">
                    ...
                    <button class="btn btn-primary" onclick="window.location.href='Educational'" style="margin:5px;margin-top: 0px;">< Back</button>
...
<style>
    ...
    .cases-img img { margin:0px; background-position:center; }
    .truncate {
display: -webkit-box;
...
.editbigcon { position:fixed; left:0px; top:0px; width:100%; height:0%;  overflow:hidden;  background:rgba(0, 0, 0, 0.5); z-index:5555; transition: .5s}
...
.editcenterimg img { margin: 0px; width: 100%; height: 100%;  background-position:top; background-size: cover }
