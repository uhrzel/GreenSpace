...
<body style="width:100vw;overflow-x:hidden;">
                            ...
                            <div class="hero-cap hero-cap2 pt-70" style="text-align:center;">
                                ...
                                <nav aria-label="breadcrumb">
                                    <div class="col-lg-12 text-center mb-4" style="float:left;margin:0px;">
                                        <button class="btn btn-primary" onclick="window.location.href='Educational'" style="margin:5px;margin-top: 0px;">
                                            < Back</button>
                                                <button class="btn btn-primary" onclick="window.location.href='publisheducres'" style="margin:5px;margin-top: 0px;">Add ></button>
                                    </div>
                                    <!--  <ol class="breadcrumb">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="row" style="background-color: transparent; padding: 20px; width: 100%;">
                        ...
                        // Check if there are no pending resources for the user
                        ...
                        <div class="row" <?php echo $displayStyle; ?>>
                                        ...
                                        <div class="single-cases mb-40" style="width: 100%; border: 2px solid transparent; margin:auto; ">
                                            ...
                                            <div class="cases-caption">
                                                ...
                                                <div class="col-lg-12 text-center mb-4">
                                                    ...
                                                    <button type="button" class="btn btn-primary" style="margin: 5px; padding: 5px 20px; font-size: .9em" onclick="editresource('<?php echo $resource['resourceID']; ?>', '<?php echo htmlspecialchars($resource['title']); ?>', '<?php echo str_replace(["\r\n", "\n"], '<br>', htmlspecialchars($resource['content'])); ?>', '<?php echo $resource['date_posted']; ?>', '<?php echo $resource['user_ID']; ?>', '<?php echo $resource['img']; ?>')">Edit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="editcentercon">
            ...
            <form id="editform" autocomplete="off" style="" enctype='multipart/form-data' action="editeduc.php" method="POST">
                <div class="editcenterimg">
                    <img id="editimgsrc" style="border-radius: 15px; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;">
                    ...
                    <button type="button" class="btn btn-primary" style="position: absolute; left: 50%; top: 50px; transform: translate(-50%, 0px); padding: 5px 20px; font-size: .9em" onclick="document.getElementById('fileInputEdit').click();">Change image</button>

                    <input id="editresourceID" style="position: absolute; left: -500000px; opacity: 0" name="resourceID">
                    <input id="eddituser_ID" style="position: absolute; left: -500000px; opacity: 0" name="user_ID">
                    <div class="editfortitle"><input id="editfortitle" name="title"></div>
                </div>


                <div class="editforcontent"><textarea id="editforcontent" name="content"></textarea></div>
                <div class="editforbtn">
                    <button type="button" class="btn btn-primary" style="margin: 5px; padding: 5px 20px; font-size: .9em; background: white; color: #19181a; border: none; box-shadow: none;" onclick="closeeditbigcon()">Close</button>
                    <button type="button" class="btn btn-primary" style="margin: 5px; background: red; padding: 5px 20px; font-size: .9em" name="delete" onclick="deleteResource()">Delete</button>
                    <button type="submit" class="btn btn-primary" style="margin: 5px; padding: 5px 20px; font-size: .9em">Save</button>
                </div>
            </form>
    ...
    <script type="text/javascript">
        ...
        function editresource(resourceID, title, content, date_posted, user_ID, img) {
            ...
            document.getElementById('editimgsrc').style.backgroundImage = `url('../uploadEducRes/${img}')`;
            document.getElementById('editforcontent').value = content.replace(/<br\s*\/?>/mg, "\n"); // Replace <br> tags with newline characters
        ...
        function deleteResource() {
            if (confirm("Are you sure you want to delete this resource?")) {
                var resourceID = document.getElementById('editresourceID').value;
                var formData = new FormData();
                formData.append('delete', '1');
                formData.append('resourceID', resourceID);

                fetch('deleteEduc.php', {
                        method: 'POST',
                        body: formData
                    })
        ...
        function updateFileName() {
            ...
            fileName.value = fileInput.files[0] ? fileInput.files[0].name : localStorage.getItem("editIMG");
        }
