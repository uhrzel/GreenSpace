                        ...
                        <div class="col-xl-10 col-lg-10">
                            <div class="menu-wrapper  d-flex align-items-center justify-content-end">
                                ...
                                <div class="header-right-btn d-none d-lg-block ml-20">
                                    <a href="contact" class="btn header-btn">Make a Donation</a>
                                </div>
                            </div>
                        </div> 
                        <!-- Mobile Menu -->
...
<main>
    ...
    <style type="text/css">
            .donate img { width:100%;height:100% }
    ...
    <section class="contact-section">
        <div class="container">
              ...
              <div style="height: 480px; position: relative; overflow: hidden;" class="donatecon">
   <div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px;" class="donate">
