		...
		<div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Events Calendar</h2>
					</div>
				</div>
				...
				<div class="row">
							...
							<div class="col-xl-12">
								<div class="card rated-doctors">
									<div class="card-header border-0 pb-0">
										<h3 class="mb-0" id="textallusers" style="font-size: 1.05em;color: grey; font-weight:bold">Create a event</h3>
									</div>
									<div class="card-body">

										<form method="POST" id="addevent" action="addevent.php" enctype='multipart/form-data'>
					...
					<script>
						...
						document.getElementById("addevent").addEventListener("submit", function(event) {
							...
							submitForm("addevent", "addevent.php", function(response) {
								alert(response);
						...
						<div class="row">
							...
							<div class="col-xl-12">
								<div class="card patient-activity">
									<div class="card-header border-0 pb-0">
										<h3 class="mb-0" id="textallusers" style="font-size: 1.05em;color: grey; font-weight:bold">Events Calendar</h3>
									</div>
