                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2 pt-70">
                                ...
                                <nav aria-label="breadcrumb"  style="background: transparent;justify-content: center;display: flex;">
                                    <ol class="breadcrumb">
...
$query = "SELECT `resourceID`, `title`, `content`, `date_posted`, `user_ID`, `img` FROM `educational_resource`";
        ...
        <div class="single-cases mb-40">
            ...
            <div class="cases-caption">
                ...
                <div class="col-lg-12 text-center mb-4">
                    <button class="btn btn-primary"  style="margin: 5px; padding: 5px 20px; font-size: .9em"   onclick="readMore('<?php echo $resource['title']; ?>')">Read More</button>
                </div>
            </div>
        </div>
    </div>
