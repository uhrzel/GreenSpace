              ...
              <div class="menu-wrapper  d-flex align-items-center justify-content-end">
                ...
                <div class="main-menu d-none d-lg-block">
                  ...
                  <ul id="navigation">
                                                ...
                                                <li><a href="what-do">GreenLiving Tips</a></li>
...
<main>
  ...
  <section class="blog_area single-post-area section-padding" style="margin-top:100px;padding-top: 0px;">
...
$sql = "SELECT af.title, af.user_ID, af.content, af.date_posted, u.user_img, u.user_name, af.forum_ID, af.category
